  ...
  return (
    <AnimatePresence>
      ...
      {cart.content.length >= 1 &&
        <motion.div key='filled-cart' onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}
      ...
      {/*  ====================== EMPTY CART ====================== */}
      {cart.content.length < 1 &&
        <motion.div key='empty-cart' onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}
          className={`m-0 px-4 z-[51] absolute flex flex-col justify-between text-center w-screen min-[480px]:w-[320px] top-0 right-0 min-[480px]:right-2 min-[480px]:top-2`}
          variants={containerVariants}>
