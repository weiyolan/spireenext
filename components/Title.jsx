...
const Title = ({mainTitle, subTitle, setHeight, style}) => {
  ...
  return (
    <div ref={titleRef} style={style} className={`${style===undefined?'relative':'px-4'} text-center w-full ${darkMode?'text-white':'text-black'}`}>
        <h1 className='font-sans inline-flex font-semibold tracking-max uppercase whitespace-nowrap min-[445px]:whitespace-nowrap sm:whitespace-pre-wrap md:whitespace-nowrap text-xl sm:text-3xl lg:text-4xl mt-5 mb-2 sm:mt-6 sm:mb-2 '>
