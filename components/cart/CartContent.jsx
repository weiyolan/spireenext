      ...
      <motion.div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}
        ...
        {cart.content.length < 1 &&
          <>
            ...
            <motion.div initial={'closed'} exit='exit' className='flex flex-col justify-center items-center mt-12 mb-12' variants={childVariants}>
            ...
            <motion.div initial={'closed'} exit='exit' className='block mb-5' style={{ bottom: 0 + 'px' }} variants={childVariants}>
