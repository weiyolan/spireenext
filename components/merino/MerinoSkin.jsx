    ...
    <svg viewBox="0 0 1147 756" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="2ndSkinPoint">
        <GetPoint handleClick={handleClick} clicked={clicked}>
          <path d="M782.77 337.541C784.853 337.541 786.541 335.853 786.541 333.771C786.541 331.688 784.853 330 782.77 330C780.688 330 779 331.688 779 333.771C779 335.853 780.688 337.541 782.77 337.541Z" fill="white" />
          <path d="M782.535 346.103C789.476 346.103 795.103 340.476 795.103 333.535C795.103 326.594 789.476 320.967 782.535 320.967C775.594 320.967 769.967 326.594 769.967 333.535C769.967 340.476 775.594 346.103 782.535 346.103Z" stroke="white" strokeWidth="1.90136" />
        </GetPoint>
      </g>
      {width > 480 ? <>
