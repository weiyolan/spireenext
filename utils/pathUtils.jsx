...
export function Path(props) {
  ...
  useEffect(()=>{
    ...
    childProps.stroke = props.animateStroke?Math.abs(newOffset)===1?'transparent':'white':'white'
    childProps.fill = props.animateFill?Math.abs(newOffset)===1?props.fillColor?props.fillColor:'white':'transparent':'transparent';
    
    childProps.strokeWidth = props.strokeWidth?props.strokeWidth:'2'
  ...
  },[pathLength, dashArray, pathRef,props.animateStroke, props.inverse, props.print, props.myGradient, props.strokeWidth, props.position, scrollMin, scrollMax, mySpeed, dashLineLength , props.strokeColor, props.animateFill, prevRatio, myRatio, scrolled, props.initialDash])

  // let style={transition: 'fill 0.5s ease'}
  let style={transition: scrolled>0?props.home?'all 0.5s ease':`all ${props.drawDuration?props.drawDuration:4}s ease`:'all 0.1s ease'};
...
//   },[pathLength, dashArray, pathRef, props.inverse, props.print, props.myGradient, props.position , scrollMin, scrollMax, mySpeed, dashLineLength, props.strokeColor , props.animateFill, prevRatio, myRatio, scrolled, props.initialDash])

//   let style={transition: scrolled>0?props.home?'all 0.5s ease':`all ${props.drawDuration?props.drawDuration:6}s ease`:'all 0.1s'};
//   // let style={transition: 'fill 0.5s ease'}
