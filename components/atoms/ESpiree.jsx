...
const ESpiree = ({style, ...props}) => {
    const {darkMode} = usePageContext()

  return (
    <span {...props} className='inline-flex w-3 mr-1 sm:w-5 lg:w-6 mb-0.5 sm:mb-0' >
        <svg viewBox="0 0 39 60" fill="none" xmlns="http://www.w3.org/2000/svg">
