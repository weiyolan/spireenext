  ...
  return (
    ...
    <div id='hero-banner' style={{}} className='relative h-[100vh] w-full'>
      <div id='hero-background' className='absolute top-0 w-full h-full '>
        <Image alt='' fill priority src='/images/heroBanner.jpg' className={`object-cover ${height<650?'object-[-500px_0px]':'object-[-600px_0px]'} mobm:object-[65%_0px] `} sizes="100vw" quality={80} />
      </div>
