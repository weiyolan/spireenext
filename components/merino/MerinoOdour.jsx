...
export default function MerinoOdour({ fontSize, title, clicked, handleClick }) {
  ...
  return (
    ...
    <g>
      ...
      {width > 420 ? <>
        <PathMerino clicked={clicked} d={`${"M291 306.5 H472 L603 233"}`} stroke="url(#paint0_linear_608_13503)" strokeWidth="2.14452" />
        <TextMerino clicked={clicked}
          onClick={() => handleClick(!clicked)}
          id="Odour" fill="#FFFAEA" fontSize={fontSize} fontWeight="300" letterSpacing="0em"><tspan x="289" y="298.866">{title}</tspan></TextMerino>
        ...
        <>
          ...
          <TextMerino clicked={clicked}
            onClick={() => handleClick(!clicked)}
            id="Odour" fill="#FFFAEA" fontSize={fontSize} fontWeight="300" letterSpacing="0em">
