  ...
  return (
    <AnimateSVG alt='Story Part 6, the logo of Spirée' scrollMin={scrollMin} scrollMax={scrollMax} animationSpeed={speed}>
      ...
      {mobile ?
        ...
        <g id='desktop'>
          <Path drawDuration='1' position={0} id="toSpireePath" d="M343.5 843C287.99 938.5 80.5098 924 34.01 896.5C-30.9772 858.066 11.51 800.961 64.5 843C139.5 902.5 -49.5003 1038.22 53.9998 1090" stroke="white" stroke-width="2" stroke-linecap="round" />
