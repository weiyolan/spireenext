    ...
    <svg viewBox="0 0 1147 756" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="QuickdryPoint">
        <GetPoint handleClick={handleClick} clicked={clicked}>
          <path d="M723.77 275.541C725.853 275.541 727.541 273.853 727.541 271.771C727.541 269.688 725.853 268 723.77 268C721.688 268 720 269.688 720 271.771C720 273.853 721.688 275.541 723.77 275.541Z" fill="#FFFAEA" />
          <path d="M723.535 284.103C730.476 284.103 736.103 278.476 736.103 271.535C736.103 264.594 730.476 258.967 723.535 258.967C716.594 258.967 710.967 264.594 710.967 271.535C710.967 278.476 716.594 284.103 723.535 284.103Z" stroke="#FFFAEA" strokeWidth="1.90136" />
        </GetPoint>
      </g>
      ...
      {width > 480 ? <>    <g id="QuickdryPath" >
        ...
        <>
          ...
          <TextMerino clicked={clicked}
            onClick={() => handleClick(!clicked)} id="Quickdry" fill="#FFFAEA" fontSize={fontSize} fontWeight="300" letterSpacing="0em">
