      ...
      <SVGWrapper myRatio={allRatios} prevRatio={allPrevRatios} scrollMin={scrollMin} scrollMax={scrollMax} animationSpeed={speed}>
        ...
        <svg alt='Story Part 1, girl in dynamic running pose' style={{transform: `translate(-50%, ${-0*scrolled}px)`}} viewBox="0 0 1468 2328" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <Path drawDuration='1' position={0} inverse={false} double={1} handleLength={(l,i)=>handleLength(1,l,i)} id="fromAstrid" d="M574.01 511.5C586.344 521.5 623.449 552.425 669.01 543.5C717.51 534 693.51 479.5 747.01 469C800.51 458.5 819.51 513 874.51 497.5C929.51 482 949.51 460.5 949.51 378" stroke="white" stroke-width="2" stroke-linecap="round"/> */}
            ...
            <Path animateFill={true} animateStroke={true} id='Tail3' position={5} inverse={false} handleLength={(l,i)=>handleLength(1,l,i)} d="M946.809 353.676C946.844 353.676 946.873 353.663 946.873 353.646L950.555 352.662L950.5 357.575L946.905 358.626H946.809L946.809 353.676Z" fill="white"/>
            <Path animateFill={true} animateStroke={true} id='Tail2' position={4} inverse={false} handleLength={(l,i)=>handleLength(1,l,i)} d="M947.131 370.764L947.025 365.426L950.361 364.589L950.21 369.591L947.131 370.764Z" fill="white"/>
            <Path animateFill={true} animateStroke={true} id='Tail1' position={3} inverse={false} handleLength={(l,i)=>handleLength(1,l,i)} d="M947.609 383.017L947.383 376.47L950.03 375.58L949.776 381.873L947.609 383.017Z" fill="white"/>
            <Path animateFill={true} animateStroke={true} id="Tail0" position={2} inverse={false} handleLength={(l,i)=>handleLength(1,l,i)} d="M949.613 386.297L949.184 394.632L948.126 395.421L947.766 387.012L949.613 386.297Z" fill="white"/>
