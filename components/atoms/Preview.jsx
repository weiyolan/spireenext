...
export default function Preview({title,subTitle,src}) {
  return (
    ...
    <h3 className='font-quick text-8xl text-center text-white font-light'>{title}</h3>
    ...
    <h4 className='font-sans text-white text-xl text-center whitespace-pre font-extralight'>{subTitle}</h4>
  </div>
  )
}
