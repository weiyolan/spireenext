...
export default function SunTitle({ sun }) {
  return (
    <div className={`flex z-[2] relative md:absolute w-full mb-6 sm:mb-10 md:mb-0 flex-col ${sun ? 'items-start text-left ml-0 left-0' : 'items-end text-right mr-0 bottom-0 right-0 '}`}>
