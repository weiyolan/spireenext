    ...
    <g>
      <g id="NaturalPoint">
        ...
        <GetPoint handleClick={handleClick} clicked={clicked}>
          ...
          <path d="M641.774 164.716C643.857 164.716 645.545 163.028 645.545 160.946C645.545 158.863 643.857 157.175 641.774 157.175C639.692 157.175 638.004 158.863 638.004 160.946C638.004 163.028 639.692 164.716 641.774 164.716Z" fill="#FFFAEA" />
          <path d="M641.535 173.103C648.476 173.103 654.103 167.476 654.103 160.535C654.103 153.594 648.476 147.967 641.535 147.967C634.594 147.967 628.967 153.594 628.967 160.535C628.967 167.476 634.594 173.103 641.535 173.103Z" stroke="#FFFAEA" strokeWidth="1.90136" />
        </GetPoint>
      </g>
      {width > 480 ? <><PathMerino clicked={clicked} d="M399 69H522.26L642.255 161.083" stroke="url(#paint4_linear_608_13503)" strokeWidth="2.14452" />
        ...
        <TextMerino clicked={clicked}
          ...
          id="Natural" fill="#FFFAEA"  fontSize={fontSize} fontWeight="300" letterSpacing="0em">
        ...
        <TextMerino clicked={clicked}
          onClick={() => handleClick(!clicked)} id="Natural" fill="#FFFAEA"  fontSize={fontSize} fontWeight="300" letterSpacing="0em">
