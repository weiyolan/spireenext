  ...
  return (
    <AnimateSVGBanner print={false} alt='Story Part 2, a medical staff caduceus illustrating Astrids doctorate in pharmacy'
      ...
      {mobile ? <g id='mobile'>
        ...
        d="M351.698 797.416C479.229 833.871 431.006 733.407 494.185 690.492C570.998 638.316 714.43 806.968 776.143 547.499C843.901 262.617 970.631 568.967 1081.62 423.834" stroke="#FFFAEA" stroke-width="2" stroke-linecap="round" />
        ...
        d="M575 513.718C678.028 597.254 673.054 485.926 748 471.217C839.12 453.334 904.946 664.717 1063.45 450.217C1237.47 214.709 1233.95 546.217 1392.95 456.217" stroke="#FFFAEA" stroke-width="2" stroke-linecap="round" />
