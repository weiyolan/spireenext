  ...
  return (
    <div  style={{ height: height - (titleHeight || 0) }  } id={name} className={`flex w-full flex-col md:flex-row`}>
      <div style={{ ...fadeStyle(), ...{ height: height } }} className='absolute z-0 top-0 left-0 h-[720px] w-full '>
        ...
        <Image style={{ objectPosition: `-${218 + offset}px 0px` }} alt='' fill src='/images/merinoBackgroundWideSmallSize.jpg' priority className={`object-cover object-left-bottom `} sizes="100vw" quality={80} />
