...
export default function Home({ }) {
  ...
  function getButtonPositionY(y) {
    ...
    let Y = titleHeight + scrollingDivHeight - (svgHeight * y / (mobile ? 5157 : 2342))
    // console.log('========================================')
    // console.log(titleHeight, scrollingDivHeight)
    // console.log(-(svgHeight * y / (mobile ? 5157 : 2342) ), y / (mobile ? 5157 : 2342), svgHeight, )
    return Y
  }
  ...
  return (
    <>
      <Head>
        <title>Meet Astrid | Spirée 2026</title>
      ...
      <main style={{ height: heightToScroll + 'px' }} className={`w-full`} onClick={handleLightboxes}>
        ...
        >
          ...
          <section className='flex w-4/5 mx-auto ' >
            ...
            {/* <div style={{ transform: `translate(${getButtonPositionX(mobile ? 0 : -9.5)}px, calc(-100% + ${getButtonPositionY(mobile ? 0 : 1344)}px) ` }} className='absolute left-1/2 top-0'>
              <Button text='Pre-Order' to='pre-order'
                ...
                className={`relative ${finished ? 'visible ' : mobile ? (scrolled > 0.92 ? 'visible ' : 'invisble') : 'invisible'}`}
                style={{transition:'all 0.5s ease, opacity 1.5s ease', opacity: finished ? 1 : mobile ? (scrolled > 0.92 ? 1 : 0) : 0}}
              />
            </div> */}
          </section>

            {/* <div style={{ transform: `translate(calc(-50% + ${getButtonPositionX(mobile ? 0 : 164)}px), calc(-50% + ${getButtonPositionY(mobile ? 0 : 1070)}px)` }} className='absolute left-1/2 top-0'>
              <Button text='Homepage' to='/'
                small={screenWidth < 900} med={screenWidth > 900} tabIndex={finished ? 0 : mobile ? (scrolled > (mobile ? 0.35 : 0.51) ? 0 : -1) : -1}
                className={`transition-all ${finished ? 'visible ' : mobile ? (scrolled > (mobile ? 0.35 : 0.51) ? 'visible ' : 'invisble') : 'invisible'}`}
                style={{transition:'all 0.5s ease, opacity 1.5s ease', opacity: finished ? 1 : mobile ? (scrolled > (mobile ? 0.35 : 0.51) ? 1 : 0) : 0}}
              />
            </div> */}
            ...
            <ButtonBig tabIndex={finished ? 0 : mobile ? (scrolled > 0.92 ? 0 : -1) : -1}
              ...
              style={{
                width: `${svgWidth * (mobile ? 0.487839 : 0.23276) - 12}px`, height: `${svgHeight * (mobile ? 0.02113222179 : 0.0465414175) - 8}px`,
                ...
                opacity: finished ? 1 : mobile ? (scrolled > 0.92 ? 1 : 0) : 0, transition: 'opacity 1.5s ease, background 0.5s ease, border 0.5s ease'
              }} text='join' to='support' />
