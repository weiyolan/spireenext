...
export default function AllSupportCards() {
  ...
  return (
    ...
    <section className='w-full flex overflow-x-scroll sm:overflow-x-hidden flex-row sm:flex-wrap relative items-center justify-start sm:justify-center sm:items-start mx-auto mt-4 '>
