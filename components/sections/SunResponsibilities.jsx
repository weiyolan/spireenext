...
export default function SunResponsibilities({className}) {
 const {sun} = usePageContext()
  return (
    <div className={` relative -top-20  mb-12 pt-4 pb-14 px-16 rounded-[40px] transition-all duration-[2.5s] ${sun?'bg-[#D9698F]':'bg-[#228F93]'}  ${className} shadow-2xl shadow-black/30`}>
      <SubTitle className={'mb-8'} mainTitle='Global Responsibility' subTitle='Elevate your performance, sustainably.' />

      <div className='flex w-full gap-12 text-primary font-quick'>
