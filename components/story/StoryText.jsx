...
export default function StoryText({ scrollMin, scrollMax, speed }) {
  ...
  let { scrolled, locale, screens, width} = useAppContext();
    let {svgWidth, viewBox, mobile, setTextLocation,setAnimationLocation} = usePageContext()
